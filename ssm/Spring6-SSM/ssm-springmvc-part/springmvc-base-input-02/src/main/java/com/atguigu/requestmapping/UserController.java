...
public class UserController {
     ...
     *                            访问: 类地址 + 方法地址即可
     *                            4. 请求方式指定
     *                            客户端 -> http (get | post | put | delete ) -> ds ->
     *                            handler
     ...
     *                            5.注解进阶 只能使用在方法上!
     *                            get @GetMapping
     *                            == @RequestMapping(xxx,method=GET);
     *                            post @PostMapping
     *                            == @RequestMapping(xxx,method=POST);
     *                            put @PUTMapping
     *                            == @RequestMapping(xxx,method=PUT);
     *                            delete @DeleteMapping
     *                            == @RequestMapping(xxx,method=DELETE);
     *
     */
